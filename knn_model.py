...
class UniversalKNNClassifier:
    def __init__(self, num_cols=None, cat_cols=None, model_params=None):
        self.num_cols = num_cols or []
        self.cat_cols = cat_cols or []
        self.model_params = model_params or {"n_neighbors": 5}
        self.pipeline = None
...
if __name__ == "__main__":
    ...
    print("KNN Classifier:", UniversalKNNClassifier().fit(Xc_tr, yc_tr).evaluate(Xc_te, yc_te))
    ...
    print("KNN Regressor:", UniversalKNNRegressor().fit(Xr_tr, yr_tr).evaluate(Xr_te, yr_te))
