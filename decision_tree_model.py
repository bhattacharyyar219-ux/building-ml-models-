...
class UniversalDecisionTreeClassifier:
    def __init__(self, num_cols=None, cat_cols=None, model_params=None):
        self.num_cols = num_cols or []
        self.cat_cols = cat_cols or []
        self.model_params = model_params or {"max_depth": None, "random_state": 42}
        self.pipeline = None
...
class UniversalDecisionTreeRegressor:
    def __init__(self, num_cols=None, cat_cols=None, model_params=None):
        self.num_cols = num_cols or []
        self.cat_cols = cat_cols or []
        self.model_params = model_params or {"max_depth": None, "random_state": 42}
...
if __name__ == "__main__":
    ...
    print("Decision Tree Classifier:", UniversalDecisionTreeClassifier().fit(Xc_tr, yc_tr).evaluate(Xc_te, yc_te))
    ...
    print("Decision Tree Regressor:", UniversalDecisionTreeRegressor().fit(Xr_tr, yr_tr).evaluate(Xr_te, yr_te))
