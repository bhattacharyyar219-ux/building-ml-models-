...
class UniversalLightGBMClassifier:
    def __init__(self, num_cols=None, cat_cols=None, model_params=None):
        if not _LGBM_AVAILABLE:
            raise ImportError("lightgbm not installed. Run: pip install lightgbm")
        self.num_cols = num_cols or []
        self.cat_cols = cat_cols or []
        self.model_params = model_params or {"n_estimators": 300, "learning_rate": 0.05, "random_state": 42, "verbose": -1}
        self.pipeline = None
...
class UniversalLightGBMRegressor:
    def __init__(self, num_cols=None, cat_cols=None, model_params=None):
        if not _LGBM_AVAILABLE:
            raise ImportError("lightgbm not installed. Run: pip install lightgbm")
        self.num_cols = num_cols or []
...
if __name__ == "__main__":
    ...
    print("LightGBM Classifier:", UniversalLightGBMClassifier().fit(Xc_tr, yc_tr).evaluate(Xc_te, yc_te))
    ...
    print("LightGBM Regressor:", UniversalLightGBMRegressor().fit(Xr_tr, yr_tr).evaluate(Xr_te, yr_te))
